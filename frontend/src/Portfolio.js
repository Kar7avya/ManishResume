...
//   </button>
// </a>
//                   <button className="btn btn-lg rounded-circle p-3"
//                           style={{background: 'linear-gradient(to right, #4b5563, #6b7280)', border: 'none', width: '64px', height: '64px'}}
...
//     // This is a placeholder for your actual form submission logic (e.g., using a service like Formspree, EmailJS, or a backend).
//     // The following code simulates a network request.
//     try {
